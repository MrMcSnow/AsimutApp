...
class CardManagementActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cardAdapter = CardAdapter(cards, ::handleCardClick, ::showManualCardInfoDialog)
    ...
    private fun clearOldCardsIfNeeded() {
        ...
        studentCardStorage.clear()
        MensaCardStorage(this).clear()
    ...
    private fun showCardsResetDialog() {
        ...
        val dialog = AlertDialog.Builder(this)
            ...
            .setPositiveButton(R.string.cards_reset_dialog_button) { dialogInterface, _ ->
    ...
    private fun showManualCardInfoDialog(@Suppress("UNUSED_PARAMETER") card: CardItem.StudentCard) {
        activeDialog?.dismiss()
        val dialog = AlertDialog.Builder(this)
            .setTitle(R.string.manual_card_info_title)
            .setMessage(R.string.manual_card_info_message)
            .setPositiveButton(R.string.manual_card_info_button) { dialogInterface, _ ->
                dialogInterface.dismiss()
            }
            .create()
        dialog.setOnDismissListener { if (activeDialog === dialog) activeDialog = null }
    ...
    private fun saveStudentCardData(firstName: String, lastName: String, matrikelnummer: String, birthDate: String) {
        ...
        loadCards()
        maybePromptForDefaultPaymentSelection(card.id)
    ...
    companion object {
        ...
        private const val PREFS_APP = "asimut_prefs"
